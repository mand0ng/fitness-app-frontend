...
const SignupPage = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-background px-10">
            ...
            {success && (
                <div className="fixed px-10 inset-0 flex items-center justify-center z-50 w-full h-full bg-background/90">
            ...
            >
                <h1 className="text-xl md:text-2xl font-bold mb-4 text-center">Sign Up</h1>
                {error && (
